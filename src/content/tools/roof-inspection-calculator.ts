...
export const ROOF_INSPECTION_CALCULATOR_CONTENT: CalculatorContent = {
  title: "Roof Inspection Calculator",
  ...
  article: {
    title: "Complete Guide to Roof Inspection and Repair Costs",
    content: `
      <h2>Understanding Roof Inspection</h2>
      <p>Professional roof inspection is essential for protecting your home investment and ensuring proper system functionality. Average costs range from 00-00, with additional repair costs varying based on severity and scope of issues found.</p>
      ...
      <h2>Conclusion</h2>
      <p>Professional roof inspection is a wise investment that protects your home, ensures safety, and maintains property value. The cost of regular inspections is minimal compared to potential emergency repairs, system replacements, and decreased property values from undiscovered issues.</p>
    `,
  },
  calculator: {
    fields: [
