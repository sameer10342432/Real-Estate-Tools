export const AiAskAUsRealtorBotContent = {
...
Get instant answers to real estate questions from an AI-powered realtor bot trained on US real estate laws, practices, and market insights
