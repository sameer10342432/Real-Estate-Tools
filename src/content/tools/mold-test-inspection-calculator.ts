...
export const MOLD_TEST_INSPECTION_CALCULATOR_CONTENT: CalculatorContent = {
  title: "Mold Test & Inspection Calculator",
  ...
  article: {
    title: "Complete Guide to Mold Testing and Remediation Costs",
    content: `
      <h2>Understanding Mold Inspection</h2>
      <p>Professional mold inspection is essential for protecting your home investment and ensuring family safety. Average costs range from 00-00, with additional remediation or repair costs varying based on severity and scope of issues found.</p>
      ...
      <h2>Conclusion</h2>
      <p>Professional mold inspection provides critical information for homeowners, buyers, and sellers. The cost of inspection is minimal compared to potential health risks, property damage, and decreased property values from undiscovered issues.</p>
    `,
  },
  calculator: {
    fields: [
