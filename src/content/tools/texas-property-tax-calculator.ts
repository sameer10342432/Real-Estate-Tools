export const TexasPropertyTaxCalculatorContent = {
  ...
  slug: 'texas-property-tax-calculator',
...
Calculate Texas property taxes with no state income tax but variable county and school district rates. Includes homestead exemptions
