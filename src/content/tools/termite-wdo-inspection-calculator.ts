...
export const TERMITE_WDO_INSPECTION_CALCULATOR_CONTENT: CalculatorContent = {
  title: "Termite (WDO) Inspection Calculator",
  ...
  article: {
    title: "Complete Guide to Termite and WDO Inspection Costs",
    content: `
      <h2>Understanding Termite/WDO Inspection</h2>
      <p>Professional termite/wdo inspection is essential for protecting your home investment and ensuring family safety. Average costs range from 5-50, with additional remediation or repair costs varying based on severity and scope of issues found.</p>
      ...
      <h2>Conclusion</h2>
      <p>Professional termite/wdo inspection provides critical information for homeowners, buyers, and sellers. The cost of inspection is minimal compared to potential health risks, property damage, and decreased property values from undiscovered issues.</p>
    `,
  },
  calculator: {
    fields: [
