...
export const FOUNDATION_INSPECTION_CALCULATOR_CONTENT: CalculatorContent = {
  title: "Foundation Inspection Calculator",
  ...
  article: {
    title: "Complete Guide to Foundation Inspection and Repair Costs",
    content: `
      <h2>Understanding Foundation Inspection</h2>
      <p>Professional foundation inspection is essential for protecting your home investment and ensuring family safety. Average costs range from 00-00, with additional remediation or repair costs varying based on severity and scope of issues found.</p>
      ...
      <h2>Conclusion</h2>
      <p>Professional foundation inspection provides critical information for homeowners, buyers, and sellers. The cost of inspection is minimal compared to potential health risks, property damage, and decreased property values from undiscovered issues.</p>
    `,
  },
  calculator: {
    fields: [
