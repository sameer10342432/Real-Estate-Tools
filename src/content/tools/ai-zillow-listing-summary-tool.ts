export const AiZillowListingSummaryToolContent = {
...
Automatically summarize Zillow property listings with key highlights, pros, cons, and investment potential using AI analysis
